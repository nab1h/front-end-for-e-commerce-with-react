...
import { openDialogDelete, openEditProduct, productName, setCurrentProduct } from "@/features/globalSlice";
...
const ProductsTable = () => {
  ...
  const deleteHandler = (item: InputValueEdit) => {
    dispatch(openDialogDelete(item.id));
    dispatch(productName(item.name));
  };
